...
const RecommendationsSection = ({ products, loading }) => {
  ...
  const productsToShow =
    selectedCategory === "all" ? products : transformedCategoryProducts;
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 pb-6 px-2">
        <h2
          className="text-2xl md:text-3xl font-bold m-0 leading-tight"
      ...
      {/* Categories */}
      <div
        className={`sticky top-0 z-10 transition-all duration-300 border-b py-4 ${
          isScrolled ? "shadow-[0_8px_32px_rgba(37,99,235,0.15)]" : ""
        }`}
        style={{
          background: "var(--primary-bg)",
      ...
      >
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 px-2">
          {categoriesList.map((category) => (
            <button
              key={category.key}
              className={`relative flex items-center justify-center w-full min-h-[44px] px-4 py-2 rounded-full border-2 font-semibold text-xs md:text-sm uppercase tracking-wide transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
            ...
            >
              ...
              {selectedCategory === category.key && (
                <span
                  className="absolute bottom-[-6px] left-1/2 -translate-x-1/2 w-8 h-1 rounded-full animate-[slideIn_0.3s_ease]"
          ...
          {productsToShow.map((product) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className="absolute top-0 left-0 w-full h-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10"
                  style={{
                    background:
                      "linear-gradient(to right, var(--accent-gradient-from, #2563eb), var(--accent-gradient-to, #60a5fa))",
                  }}
                />
                {/* Favorite Button */}
                <button
                ...
                {/* Product Image */}
                <div
                  className="relative w-full h-40 mb-4 flex items-center justify-center rounded-xl overflow-hidden"
                ...
                >
                  ...
                  {discountPercentage > 0 && (
                    <div
                      className="absolute top-3 left-3 text-white text-xs font-semibold px-3 py-1.5 rounded-full shadow-[0_2px_8px_rgba(37,99,235,0.3)] z-20"
                      style={{ background: "var(--accent-text, #2563eb)" }}
                    >
                      -{discountPercentage}%
                    </div>
                ...
                <div className="flex flex-col gap-2 flex-1">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M7 1L8.854 5.078L13 5.724L10 8.84L10.708 13L7 11.078L3.292 13L4 8.84L1 5.724L5.146 5.078L7 1Z"
                          fill="#FFC107"
                          stroke="#FFC107"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <span
                    className="text-base font-semibold mb-1 leading-tight line-clamp-2 min-h-[2.8em]"
                    style={{ color: "var(--primary-text)" }}
                  >
                    {product.title}
                  </span>
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d="M0.833336 1.66667H4.16667L6.4 12.0917C6.4761 12.4253 6.68485 12.72 6.9796 12.9118C7.27436 13.1036 7.63276 13.1778 7.98334 13.1167H15.15C15.5006 13.1778 15.859 13.1036 16.1537 12.9118C16.4485 12.72 16.6572 12.4253 16.7333 12.0917L18.3333 5.00001H5.00001"
                      stroke="currentColor"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
