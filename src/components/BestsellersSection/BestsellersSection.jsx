        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-6 md:gap-6 xl:gap-8 w-full box-border overflow-x-hidden">
            ...
            <div
              ...
              className="relative flex flex-col justify-center rounded-2xl shadow-[0_8px_32px_rgba(37,99,235,0.15)] p-8 md:p-8 lg:p-10 xl:p-12 mb-4 md:mb-0 overflow-hidden col-span-1 md:col-span-2 lg:col-span-3"
            >
              {/* Decorative circle */}
              <div
              ...
              />
              <span
                className="font-semibold text-sm mb-2 uppercase tracking-wider bg-white/15 px-4 py-2 rounded-full w-fit backdrop-blur-sm"
                style={{ color: "var(--primary-text)" }}
              >
                {t("bestsellers.subtitle")}
              </span>
              <h2
                className="text-3xl md:text-2xl lg:text-3xl xl:text-4xl mb-4 font-bold leading-tight"
                style={{
                  color: "var(--primary-text)",
              ...
              <p
                className="text-base md:text-base lg:text-lg xl:text-lg leading-relaxed mb-6 max-w-[70%]"
                style={{ color: "var(--primary-text)" }}
              >
            ...
            {products.map((product, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className="relative pt-[100%] lg:pt-[90%] xl:pt-[85%] mb-4 rounded-xl overflow-hidden"
                  ...
                  >
                    ...
                    <span className="font-semibold text-blue-500 uppercase tracking-wide text-sm">
                      {product.brand || product.category}
                    </span>
                  </div>
                  <h3
                    className="text-base lg:text-base xl:text-lg font-semibold mb-2 leading-tight line-clamp-2 min-h-[2.8em]"
                    style={{ color: "var(--primary-text)" }}
                  >
                    {product.title}
                  </h3>
